...
from data.data_tools.ezData import ezData_numpy



class RollingSum(ezData_numpy):
    def __init__(self, data):
        super().__init__(x=data, y=None)
...
class XLocations(ezData_numpy):
    def __init__(self, x, y):
        super().__init__(x=x, y=None)
