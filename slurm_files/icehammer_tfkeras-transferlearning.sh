#!/bin/bash
#SBATCH --job-name=ezCGP_transferlearning            # name of job
...
#SBATCH --output=tfkeras_transferlearning.out        # output file relative to ezcgp folder
...
rm -rf ~/.nv
python main.py -p problem_tfkeras_transferlearning -d $setseed $setprevrun
