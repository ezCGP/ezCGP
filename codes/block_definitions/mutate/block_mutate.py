...
class BlockMutate_ProbabilisticMutation(BlockMutate_Abstract):
    '''
    simple benchmarking mutation
    '''
    def __init__(self):
        ezLogging.debug("%s-%s - Initialize BlockMutate_ProbabilisticMutation Class" % (None, None))
        self.prob_mutate = 1.0
        self.num_mutants = 4
