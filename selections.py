###
# STOLEN FROM DEAP
# https://github.com/DEAP/deap/blob/232ed17142da1c8bb6a39179018f8278b122aada/deap/tools/emo.py
###
...
#from configuration import seed, set_mate_rate, adaptable, pop_size
set_mate_rate = 1
adaptable = False
pop_size = 9
...
def selNSGA2(individuals, k, nd='standard'):
    ...
    """
    if nd == 'standard':
        pareto_fronts, mate_rate = sortNondominated(individuals, k)
    elif nd == 'log':
...
def sortNondominated(individuals, k, first_front_only=False):
    ...
    # CAN'T ITERATE OVER KEYS IN PYTHON3. FIXED:
    ...
    if adaptable:
        ...
        mate_rate = m * (len(fronts[-1]) - 1) + set_mate_rate
